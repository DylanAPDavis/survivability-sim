...
public class TabuSearchService {
    ...
    static int minThresholdKeepAfterRestart = 3; // only keep parts of the best solution that have been around for this many iterations
