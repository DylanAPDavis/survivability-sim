...
public class FailureAreaService {
    ...
    public FailureAreaService(){
        ...
        FailureArea quake1 = new FailureArea(37.441883, -122.143019, 1500, false); // Palo Alto
        FailureArea quake2 = new FailureArea(40.825763, -96.685198, 1000, false); // Lincoln
        FailureArea quake3 = new FailureArea(33.748995, -76.93776, 750, false); // Atlanta Lat, CP Long
        FailureArea nuke1 = new FailureArea(37.441883, -122.143019, 1500, true);
        FailureArea nuke2 = new FailureArea(40.825763, -96.685198, 1000, true);
        FailureArea nuke3 = new FailureArea(33.748995, -84.387982, 750, true);
